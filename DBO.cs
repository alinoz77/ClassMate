...
namespace ClassMate.DBO
{
    public class DBOHandler {
        ...
        string cloudConnectionString = "Server=tcp:classmate.database.windows.net,1433;Database=ClassMate;User ID=sefu@classmate;Password={your_password_here};Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
